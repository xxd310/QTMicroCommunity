package com.zhihuitech.qtwsq.util;
...
public class ImageDownloader {
	 ...
	 * @return
	 */
	public Bitmap downloadImage(final ImageView iv, final String url,
								final onImageLoaderListener listener) {
		// 替换Url中非字母和非数字的字符
		final String subUrl = url.substring(url.lastIndexOf("/"));
//		final String subUrl = url.replaceAll("[^\\w]", "");
		...
		if (bitmap != null) {
			...
			final Handler handler = new Handler() {
				...
				public void handleMessage(Message msg) {
					...
					listener.onImageLoader(iv, (Bitmap) msg.obj, url);
				}
			};
	...
	public interface onImageLoaderListener {
		void onImageLoader(ImageView iv, Bitmap bitmap, String url);
	}
